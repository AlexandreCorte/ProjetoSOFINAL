...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := tests/test1 tests/copy_to_external_simple tests/copy_to_external_errors tests/write_10_blocks_spill tests/write_10_blocks_simple tests/write_more_than_10_blocks_simple tests/two_writes tests/write_append tests/max_dir_entries tests/testes_para_avaliacao/test_avaliacao_1 tests/testes_para_avaliacao/test_avaliacao_2
...
tests/two_writes: tests/two_writes.o fs/operations.o fs/state.o
tests/write_append: tests/write_append.o fs/operations.o fs/state.o
tests/max_dir_entries: tests/max_dir_entries.o fs/operations.o fs/state.o
tests/testes_para_avaliacao/test_avaliacao_1: tests/testes_para_avaliacao/test_avaliacao_1.o fs/operations.o fs/state.o
tests/testes_para_avaliacao/test_avaliacao_2: tests/testes_para_avaliacao/test_avaliacao_2.o fs/operations.o fs/state.o
...
run:
	...
	tests/./write_append
	tests/./max_dir_entries

run1:
	tests/testes_para_avaliacao/./test_avaliacao_1

run2:
	tests/testes_para_avaliacao/./test_avaliacao_2
